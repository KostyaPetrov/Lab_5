...
public class CommandManager{
    ...
    public CommandManager(CollectionManager collectionManager, ConsoleManager consoleManager, FileManager fileManager){
        ...
        addCommand("help", new Help());//вывести справку по доступным командам
        ...
        addCommand("save", new Save(fileManager, collectionManager));//     : сохранить коллекцию в файл
        addCommand("execute_script", new ExecuteScript(consoleManager, fileManager, collectionManager));//     : считать и исполнить скрипт из указанного файла. В скрипте содержатся команды в таком же виде, в котором их вводит пользователь в интерактивном режиме.
